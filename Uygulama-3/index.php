        ...
        <div class="row">
            ...
            <div class="col-9">
                ...
                <div class="card mb-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="img/<?php echo $kurslar["1"]["resim"]; ?>" alt="php"
                ...
                <div class="card mb-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="img/<?php echo $kurslar["2"]["resim"]; ?>" alt="python"
                                class="img-fluid rounded-start">
                        </div>
                        <div class="col-8">
                            <div class="card-body">
                ...
                <div class="card mb-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="img/<?php echo $kurslar["3"]["resim"]; ?>" alt="node.js"
                                class="img-fluid rounded-start">
                        </div>
                        <div class="col-8">
                            <div class="card-body">
                ...
                <div class="card mb-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="img/<?php echo $kurslar["4"]["resim"]; ?>" alt="node.js"
                                class="img-fluid rounded-start">
                        </div>
                        <div class="col-8">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="<?php echo $kurs4_url; ?>"><?php echo $kurslar["4"]["baslik"]; ?></a>
                                </h5>
